 ...
 */
final class Version20220314120835 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD is_moderated TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP is_moderated, CHANGE content content LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');

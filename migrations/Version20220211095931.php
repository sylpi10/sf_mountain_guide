 ...
 */
final class Version20220211095931 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE news_letter ADD title VARCHAR(255) NOT NULL, ADD message LONGTEXT NOT NULL');
        $this->addSql('ALTER TABLE newsletter_subscriber ADD newsletter_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE newsletter_subscriber ADD CONSTRAINT FK_401562C322DB1917 FOREIGN KEY (newsletter_id) REFERENCES news_letter (id)');
        $this->addSql('CREATE INDEX IDX_401562C322DB1917 ON newsletter_subscriber (newsletter_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE news_letter DROP title, DROP message, CHANGE fullname fullname VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE email email VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE newsletter_subscriber DROP FOREIGN KEY FK_401562C322DB1917');
        $this->addSql('DROP INDEX IDX_401562C322DB1917 ON newsletter_subscriber');
        $this->addSql('ALTER TABLE newsletter_subscriber DROP newsletter_id, CHANGE fullname fullname VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE email email VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
